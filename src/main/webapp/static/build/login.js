...
/***/ function(module, exports, __webpack_require__) {
	            ...
	            React.createElement("form", {className: "form-area", url: "${base}/user/login", method: "post", onSubmit: this.handleSubmit}, 
	                ...
	                React.createElement("div", {className: "checkbox"}, 
	                    React.createElement("label", null, 
	                        React.createElement("input", {type: "checkbox", name: "remember"}), " 记住我"
	                    )
	                ), 
	...
	React.render(React.createElement(LoginForm, null), document.getElementById('js-login-form'));
